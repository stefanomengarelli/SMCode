...
namespace SMCode
{
    ...
    /// <summary>SMCode basic class: math.</summary>
    public partial class SM
    {
        ...
        /// <summary>Get or set rotor string.</summary>
        public string RotorStr { get; set; }
