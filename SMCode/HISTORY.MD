...
2.4.1 dated (upcoming)
----------------------
- Split() methods reorganization;
- Cat() method improvement;

2.4.0 dated 30-08-2026
----------------------
- started implementation of storage management class;
- restored embedded resources files management;
- default path for resources files and RealPath() method implementation;
- added property PrimaryKeyColumn to SMDataset class;
- SMDataset PrimaryKeyValue property implementation;
- added Hash property to SMFileItem class;

2.3.5 dated 24-06-2026
----------------------
- fix RealPath() method;
- fix AddPath() and Get() methods of SMResources class;

2.3.4 dated 22-06-2026
----------------------
- fix SMUser Hash method;

2.3.2 dated 18-06-2026
----------------------
- removed deprecated System.Data.SqlClient dependency from SMCode project;
- added Microsoft.Data.SqlClient dependency to SMCode project;
- added fast SMDataset columns search by name;
- SMDataset ColumnIndex() replace FieldIndex() and perform binary search for columns list with more of 5 elements;

2.3.1 dated 18-06-2026
----------------------
- real path fixes;

2.3.0 dated 17-06-2026
----------------------
- removed SMTemplates class and related methods, now templates are managed by SMResources class;

2.2.1 dated 14-06-2026
----------------------
- added topics function to macros method for datasets;
- added add if not exists option to SMDictionary Merge() method;
- RealPath() method implementation;
- resources class improvement;

2.2.0 dated 17-06-2026
----------------------
- fix ParseMacro() method;
- user macros and Replace() method improvement;
- resources management improvement;

2.1.6 dated 04-06-2026
----------------------
- fix ParseMacro() method;

2.1.5 dated 04-06-2026
----------------------
- templates load and cache optimization;
- added methods for accessing dataset fields by index and for retrieve data for macro; 
- ParseMacro() method improvement;

2.1.4 dated 04-06-2026
----------------------
- added parameters to add if not exists to SMDictionary.Set() method (default: true);
- added parameters to add default system and database macros to SM.Macros() methods (default: true);
- optimized Replace() method;
- added method SMDictionary.FromMacros();

2.1.2 dated 30-05-2026
----------------------
- added more current user macros;
- some SMMiniMax class fixes and improvements;
- update NuGet packages;
- Zip file save optimization;
- Zip/Unzip locked files fix;

2.1.1 dated 23-04-2026
----------------------
- class inner SMCode instance SM now is public readonly for external availability;

2.1.0 dated 18-04-2026
----------------------
- removed error setting if method Get() of class SMJson fail and raise exception
  parameter is false;
- added object Tag property to almost all SMCode classes;
- added SMFileItem class for single file item management;
- added data Size methods;

2.0.330 dated 16-03-2026
------------------------
- fix SMJson Get() method, now return default argument even on exception;

2.0.325 dated 16-03-2026
------------------------
- some optimizations;

2.0.324 dated 16-03-2026
------------------------
- SMDataset OpenReadonly() method implementation;
- SMDataset OpenView() method implementation;
- Login methods optimization;

2.0.323 dated 26-02-2026
------------------------
- Fix RndPassword() method;

2.0.322 dated 18-02-2026
------------------------
- string Rot() and simple rot string encryption implementation;
- string Shuffle() method implementation;
- string comparison function with matching mode implementation;
- FindValue() method implemented on SMDictionary class;

2.0.320 dated 04-01-2026
------------------------
- added About() methods for dll files;
- improved SMResources class;
- fixed ErrorStr() method;
- added Cat() method for StringBuilder;

2.0.310 dated 25-11-2025
------------------------
- ExtractArgument() method fix;
- implemented TrailingChar options on ExtractArgument() method;
- implemented TrailingChar property on SMDictionary class;

2.0.308 dated 24-11-2025
-------------------------
- SMDictionary ToParameters() method fix;

2.0.307 dated 02-11-2025
------------------------
- static and instance settings optimization;

2.0.306 dated 29-10-2025
------------------------
- added ignore case option to templates management class;
- added multiple paths to templates management class;
- SMDatabases Remove() method implementation;

2.0.305 dated 17-10-2025
------------------------
- macro optimization;

2.0.303 dated 15-10-2025
------------------------
- MacroIgnoreCase property implementation;

2.0.302 dated 14-10-2025
------------------------
- macro functions reorganization;

2.0.301 dated 02-10-2025
------------------------
- ToDate() function minor fix;

2.0.300 dated 29-09-2025
------------------------
- begin SMCode project development with SMProject, SMDesk and SMFront packages;
- some bug fixes on javascript libraries;
